...
filename <- file.path('pdf', 'issues', paste0(tolower(dataset), '-', tolower(variable), '-power-lone.pdf'))
cat('Printing:', filename, '\n')
pdf(filename, height=11, width=8.5)
grid.arrange(grobs=list(arrangeGrob(p1, p2, ncol=1),
                        arrangeGrob(p3, p4, ncol=2)),
             ncol=1, heights=c(1/2, 1/2),
...
filename <- file.path('pdf', 'issues', paste0(tolower(dataset), '-', tolower(variable), '-lone_pine-godowa-sycan.pdf'))
cat('Printing:', filename, '\n')
pdf(filename, height=11, width=8.5)
grid.arrange(grobs=list(arrangeGrob(p1, p2, ncol=1), p3),
             ncol=1, heights=c(1/2, 1/2),
